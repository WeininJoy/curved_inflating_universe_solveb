...
sys.path.insert(0, '/home/wnd22/Desktop/Work_env/Cobaya/env_Cobaya/lib/python3.10/site-packages/class_public')
sys.path.insert(0, '/home/wnd22/Desktop/Work_env/Cobaya/env_Cobaya/lib/python3.10/site-packages')
import classy
from classy import CosmoComputationError
print(classy.__file__)

plc = os.path.join(os.getcwd(),'/home/wnd22/Desktop/Work_env/Cobaya/clik_installs/code/planck/code/plc_3.0/plc-3.1')
data = os.path.join(os.getcwd(),'/home/wnd22/Desktop/Work_env/Cobaya/clik_installs/data/planck_2018/baseline/plc_3.0') 
...
bij_filename = 'MAF_bijector.pkl' # prior generated by magarine
############
...
def prior(hypercube): # parameters = [logA_SR, N_star, log10f_i, omega_k, H0]
    """ prior generated from margarine """
    bij = MAF.load(bij_filename)
    return bij(hypercube)
