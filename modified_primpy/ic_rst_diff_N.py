...
class IC_RST_diff_N(object):
    def __init__(self, background, N_qIC, k, cs=1):
        self.background = background  
        ...
        if  self.N_qIC <= self.background.N[0]: # quantum IC is set in kinetic dominance era
            ...
            ev = [UntilNEvent(eq, value=self.N_qIC, direction=-1, terminal=True)]
            ...
            ev_KD = [InflationEvent(equations, +1, terminal=True)]   # end at inflation start
            self.newbackground = solve(ic=ic_KD, events=ev_KD)
            ...
            print("N_qIC should be smaller than N_i.")
