...
from primpy.time.ic_rst_b_difft import IC_RST_b_difft
...
class ScalarModeT(ScalarMode):
    ...
    def get_vacuum_ic_RST(self):
        ...
        IC_b_difft = IC_RST_b_difft(background = self.background, w=self.w, k=self.k)
        # if 0.04 < self.k/self.background.a0_Mpc < 0.06:
        #     IC_diff_t.plot_R()
        Rk_i, dRk_i = IC_b_difft.get_R_IC()
        return Rk_i, dRk_i
